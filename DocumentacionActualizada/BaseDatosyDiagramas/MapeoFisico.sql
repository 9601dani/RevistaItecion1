...
CREATE USER 'dani'@'localhost' IDENTIFIED BY 'Dani.123';
GRANT ALL PRIVILEGES ON revista_I .* TO 'dani'@'localhost';
USE revista_I;
...
INSERT INTO administrador VALUES ('admin','admin','Admin','ACTIVO');
INSERT INTO porcentaje_soft(porcentaje,fecha_ultima_mod,nombre_usuario) VALUES (15,CURDATE(),'admin');
INSERT INTO tipo_anuncio VALUES('TEXTO',20);
INSERT INTO tipo_anuncio VALUES('TEXTO_Y_IMAGEN',30);
INSERT INTO tipo_anuncio VALUES('TEXTO_Y_VIDEO',40);