 ...
 * @author daniel
 */
@WebServlet("/comentsFinalAutorExport")
public class ComentsAutoFinalExport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String result = reportService.ReportComentsExport(autor, fechaI, fechaF);
 ...
 String fechaI= request.getParameter("fechaI");
       ...
       try {
           ...
           String result=  reportService.ReportComentsWithNameExport(autor,fechaI,fechaF, nom_revista);
