 ...
 * @author daniel
 */
@WebServlet("/reportLikesUser")
public class ReportLikesUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            String result=reportService.ReportSusForLikes(new Usuario(request.getParameter("user")));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            String fechaI = request.getParameter("fechaI");
            String fechaF = request.getParameter("fechaF");
            String result=reportService.ReportSusForLikesWhithName(request.getParameter("name"));
            System.out.println("1.  "+result);
            response.getWriter().append(new RespuestaConverter(Respuesta.class).toJson(new Respuesta(result)));
