 ...
 * @author daniel
 */
@WebServlet("/changeEstadoAnun")
public class ChangeEstado extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       String result= new AnuncioDaoImpl().desactivarAn(request.getParameter("id"));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //ACTIVAR ANUNCIO
        RespuestaConverter converter= new RespuestaConverter(Respuesta.class);
       String result= new AnuncioDaoImpl().activarAn(request.getParameter("id"));
       if(result.equals("yes")){
           response.getWriter().append(converter.toJson(new Respuesta("yes")));
       }else{
           response.getWriter().append(converter.toJson(new Respuesta("no")));
