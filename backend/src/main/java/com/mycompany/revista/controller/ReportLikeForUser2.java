 ...
 * @author daniel
 */
@WebServlet("/reportLikesUser2")
public class ReportLikeForUser2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
          ...
          try {
           ...
           ArrayList<ABeans> result=reportService.ReportSusForLikesHtml(new Usuario(request.getParameter("user")));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            String fechaI = request.getParameter("fechaI");
            String fechaF = request.getParameter("fechaF");
            ArrayList<ABeans> result=reportService.ReportSusForLikesWhithNameHtml(request.getParameter("name"));
            response.getWriter().append(toJsonABeansOficial(result));
