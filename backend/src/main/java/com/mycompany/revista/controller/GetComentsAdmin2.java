 ...
 * @author daniel
 */
@WebServlet("/reportAdm2")
public class GetComentsAdmin2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<ABeans> result = reportService.ReportMasSusHtml(LocalDate.parse(fechaI), LocalDate.parse(fechaF));
